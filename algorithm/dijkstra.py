...
def dijkstra(adj_list: Dict[int, Dict[int, any]], 
    ...
    distances: Dict[Tuple[int, Optional[str]], float] = [(0.0, source, None)]
    ...
    while priority_queue:
        current_cost, current_node = heapq.heappop(priority_queue)[:2]
        _, _, previous_line = heapq.heappop(priority_queue) if False else priority_queue_pop_helper(priority_queue)
